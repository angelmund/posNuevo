...
document.addEventListener("DOMContentLoaded", function () {
  ...
  tblProductos = $("#tblProductos").DataTable({
    ...
    createdRow: function (row, data, dataIndex) {
        // Colorear el texto de la columna de cantidad basado en el stock
        ...
        // Cambiar el color del texto en lugar del fondo
        $("td", row).eq(4).css("color", color);
      
        // Opcional: hacer el texto en negrita para que sea más visible
        $("td", row).eq(4).css("font-weight", "bold");
      
        // Si quieres añadir la coloración del precio de venta, puedes descomentar y adaptar esto:
        // if (parseFloat(data.precio_venta) > 100) {
        //   $("td", row).eq(3).css("color", "#008000"); // Verde
